# scripts/test_wrappers/grid_stage03_15km_test_v02_first_observed.R
# ==============================================================================
#
...
if (is.null(this_file) || !nzchar(this_file)) {
  stop(
    ...
    "Run via source('.../scripts/.../grid_stage03_15km_test_v02_first_observed.R') from a file, not copy/paste."
  )
}
