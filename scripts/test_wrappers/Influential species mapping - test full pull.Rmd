...
```{r}
# ---- Repo root (robust; works from scripts/test_wrappers/ or any subfolder) ----
...
gbif_out_dir  <- file.path(repo_root, "data", "raw", "gbif", "wasps")
ckpt_root     <- file.path(repo_root, "data", "_checkpoints")  # shared checkpoint root
...
# Output dirs (relative to scripts/)
nbn_out_dir  <- file.path(repo_root, "data", "raw", "nbn", "wasps")
